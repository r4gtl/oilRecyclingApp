...
class Assignment(models.Model):
    operatore = models.ForeignKey(Operatore, on_delete=models.CASCADE, related_name="assignments")
    ...
    created_by = models.ForeignKey(
        User, related_name="assignments", null=True, blank=True, on_delete=models.SET_NULL
    )
    created_at = models.DateTimeField(auto_now_add=True, null=True)
